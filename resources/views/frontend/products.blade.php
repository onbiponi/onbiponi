        ...
        <div class="col-12 col-sm-3">
            ...
            <div class="card bg-light mb-3">
                ...
                <div class="card-body">
                    ...
                    @endcomputer
                    <h5 class="card-title owl-heading">{{ $products[0]->name ?? 'No title' }}</h5>
                    <p class="card-text owl-paragraph">{{ $products[0]->note ?? 'No description' }}</p>
        ...
        <div class="col">
            <div class="row" id="products">
                ...
                <div class="col-12 col-md-6 col-lg-4 mb-4">
                    <div class="card">
                        <a href="{{ route('products.show', $product->id) }}" class="size-21 d-block">
                            @computer
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <a href="#" class="btn btn-success btn-block" @click.prevent='floatImage($event, {{ $product->id }}, {{ $product->msrp ?? 0 }}, @json($product->name), "{{ $product->image1 ?? 'not-found.jpg' }}", @json($product->description))'>Add to cart</a>
                                </div>
                            </div>
                        </div>
                    </div>
